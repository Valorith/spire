...
func (e *BaseDatumController) Routes() []*routes.Route {
	return []*routes.Route{
		...
		routes.RegisterRoute(http.MethodGet, "base_data/count", e.getBaseDataCount, nil),
...
func (e *BaseDatumController) createBaseDatum(c echo.Context) error {
	...
	db := e.db.Get(models.BaseDatum{}, c).Model(&models.BaseDatum{})
...
// getBaseDataCount godoc
// @Id getBaseDataCount
// @Summary Counts BaseData
// @Accept json
// @Produce json
// @Tags BaseDatum
// @Param includes query string false "Relationships [all] for all [number] for depth of relationships to load or [.] separated relationship names"
...
// @Success 200 {array} models.BaseDatum
// @Failure 500 {string} string "Bad query request"
// @Router /base_data/count [get]
func (e *BaseDatumController) getBaseDataCount(c echo.Context) error {
	var count int64
	err := e.db.QueryContext(models.BaseDatum{}, c).Count(&count).Error
	if err != nil {
		return c.JSON(http.StatusInternalServerError, echo.Map{"error": err.Error()})
	}

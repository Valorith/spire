...
func (e *CharacterActivityController) Routes() []*routes.Route {
	return []*routes.Route{
		...
		routes.RegisterRoute(http.MethodGet, "character_activities/count", e.getCharacterActivitiesCount, nil),
...
// getCharacterActivitiesCount godoc
// @Id getCharacterActivitiesCount
// @Summary Counts CharacterActivities
// @Accept json
// @Produce json
// @Tags CharacterActivity
// @Param includes query string false "Relationships [all] for all [number] for depth of relationships to load or [.] separated relationship names"
...
// @Success 200 {array} models.CharacterActivity
// @Failure 500 {string} string "Bad query request"
// @Router /character_activities/count [get]
func (e *CharacterActivityController) getCharacterActivitiesCount(c echo.Context) error {
	var count int64

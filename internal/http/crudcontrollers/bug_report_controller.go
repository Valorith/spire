...
func (e *BugReportController) Routes() []*routes.Route {
	return []*routes.Route{
		...
		routes.RegisterRoute(http.MethodGet, "bug_reports/count", e.getBugReportsCount, nil),
...
func (e *BugReportController) createBugReport(c echo.Context) error {
	...
	db := e.db.Get(models.BugReport{}, c).Model(&models.BugReport{})
...
// getBugReportsCount godoc
// @Id getBugReportsCount
// @Summary Counts BugReports
// @Accept json
// @Produce json
// @Tags BugReport
// @Param includes query string false "Relationships [all] for all [number] for depth of relationships to load or [.] separated relationship names"
...
// @Success 200 {array} models.BugReport
// @Failure 500 {string} string "Bad query request"
// @Router /bug_reports/count [get]
func (e *BugReportController) getBugReportsCount(c echo.Context) error {
	var count int64
	err := e.db.QueryContext(models.BugReport{}, c).Count(&count).Error
	if err != nil {
		return c.JSON(http.StatusInternalServerError, echo.Map{"error": err.Error()})
	}

...
func (e *BotStanceController) Routes() []*routes.Route {
	return []*routes.Route{
		...
		routes.RegisterRoute(http.MethodGet, "bot_stances/count", e.getBotStancesCount, nil),
...
func (e *BotStanceController) createBotStance(c echo.Context) error {
	...
	db := e.db.Get(models.BotStance{}, c).Model(&models.BotStance{})
...
// getBotStancesCount godoc
// @Id getBotStancesCount
// @Summary Counts BotStances
// @Accept json
// @Produce json
// @Tags BotStance
// @Param includes query string false "Relationships [all] for all [number] for depth of relationships to load or [.] separated relationship names"
...
// @Success 200 {array} models.BotStance
// @Failure 500 {string} string "Bad query request"
// @Router /bot_stances/count [get]
func (e *BotStanceController) getBotStancesCount(c echo.Context) error {
	var count int64
	err := e.db.QueryContext(models.BotStance{}, c).Count(&count).Error
	if err != nil {
		return c.JSON(http.StatusInternalServerError, echo.Map{"error": err.Error()})
	}

import { P as s } from "./embed-entry-BKE21f6Q.js";
class e {
  /**
   ...
   */
  beginMonitoring() {
    e.Enabled && (this._startMonitoringTime = s.Now);
  }
  /**
  ...
  _fetchResult() {
    ...
    const t = s.Now;
    t - this._lastSecTime > 1e3 && (this._lastSecAverage = this._lastSecAccumulated / this._lastSecValueCount, this._lastSecTime = t, this._lastSecAccumulated = 0, this._lastSecValueCount = 0);
  }
}
e.Enabled = !0;
export {
...
//# sourceMappingURL=perfCounter-BsJBc9Ap.js.map
